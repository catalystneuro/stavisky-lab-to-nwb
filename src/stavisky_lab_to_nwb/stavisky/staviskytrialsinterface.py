...
class StaviskyTrialsInterface(BaseDataInterface):
    ...
    def add_to_nwbfile(
        ...
        nwbfile.add_trial_column(name="delay", description="Length of delay period before go cue, in ms")
        nwbfile.add_trial_column(
            name="intertrial_interval",
            description="Length of interval between end of current trial and start of next trial, in ms",
        )
        nwbfile.add_trial_column(
            name="sentence_cue", description="The sentence cue that the subject speaks/imagines speaking"
        )
        # nwbfile.add_trial_column(
        #     name="delay_time",
        ...
        # )
        nwbfile.add_trial_column(
            name="go_cue_time", description="Time of presentation of go cue, which signals beginning of task"
        )
        # nwbfile.add_trial_column(
        #     name="task_end_time",
